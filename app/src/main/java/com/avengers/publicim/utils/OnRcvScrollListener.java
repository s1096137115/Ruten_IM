...
/*    *//**
	...
	public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
		...
		if (visibleItemCount > 0 && currentScrollState == RecyclerView.SCROLL_STATE_IDLE &&
			...
			if(mOnPositionListener != null) mOnPositionListener.onPosition(Position.BOTTOM);
		}else if(visibleItemCount > 0 && currentScrollState == RecyclerView.SCROLL_STATE_IDLE &&
				(firstVisibleItemPosition) <= 0){
			if(mOnPositionListener != null) mOnPositionListener.onPosition(Position.TOP);
		}else if(visibleItemCount > 0 && currentScrollState == RecyclerView.SCROLL_STATE_IDLE){
			if(mOnPositionListener != null) mOnPositionListener.onPosition(Position.OTHER);
		}
	}
